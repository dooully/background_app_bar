...
typedef TitleWidgetBuilder = Widget Function(BuildContext context, double radio);
...
class BackgroundFlexibleSpaceBar extends StatefulWidget {
  ...
  final TitleWidgetBuilder? titleBuilder;
...
class _BackgroundFlexibleSpaceBarState extends State<BackgroundFlexibleSpaceBar> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.title != null) {
      children.add(_createTitleWidget(t));
    } else if (widget.titleBuilder != null) {
      children.add(
        Container(
            width: double.infinity,
            height: double.infinity,
            alignment: Alignment.topLeft,
            child: widget.titleBuilder!(context, t)),
      );
    }
  ...
  Widget _createTitleWidget(double t) {
